                        ...
                        <table class="table align-middle table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                .map((report, index) =>{
                                    ...
                                    <td className="testTd"><span className="testTd">{report.title}</span></td>
                                    <td><span className="badge">{report.createdAt.slice(0, 10)}</span></td>
                                    <td><span className={(report.status == "Open") ? "badge badge-danger" : (report.status == "Closed") ? "badge badge-success" : (report.status == "Pending") ? "badge badge-warning" : ""}>{report.status}</span></td>
